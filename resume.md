...
- Architected a three-repo ML system (NCR Coach/Classy) for compliance-document review; combined NCR rejection rate fell 27.9% → 11.5% (−58.8% relative) post-launch, with AI evaluation coverage rising from 0% to 100% across 50 facilities — announced company-wide by the CEO (134 users, 887 NCRs reviewed)
